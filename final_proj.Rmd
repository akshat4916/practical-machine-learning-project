---
title: "practical machine learning project final"
...
trainingset <- read.csv("E:/pml_project/pml-training.csv", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv('E:/pml_project/pml-testing.csv', na.strings=c("NA","#DIV/0!", ""))
